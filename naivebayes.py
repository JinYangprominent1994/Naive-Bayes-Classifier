...
# =============================================================================
# fill in code here
    PositiveY, NegativeY = naivebayesPY(x,y)
    PositiveXY, NegativeXY = naivebayesPXY(x,y)
    
    logratio = np.log(PositiveY) - np.log(NegativeY) + np.matmul(x1.T, np.log(PositiveXY)) - np.matmul(x1.T, np.log(NegativeXY))
